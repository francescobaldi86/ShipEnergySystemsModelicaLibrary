...
package Examples
  ...
  model testHENmonophase
    ...
    ShipEnergySystems.Other.inputForFlangeCdot inputForFlangeCdot1 annotation(
      Placement(visible = true, transformation(origin = {24, 54}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    ShipEnergySystems.HeatExchanger.HEX_1f HEX(A_cs_pf = 0.5, A_cs_sf = 1, A_ht = 20, L = 0.5, M_wall = 1, Tsf_SU_start = 873.15, U_pf = 600, U_sf = 50, c_wall = 450, dTsf_start(displayUnit = "K") = 20, eta_fin = 1, k_wall = 60, rho_wall(displayUnit = "kg/m3") = 5000) annotation(
  ...
  model testHENtwophase
    ...
    ShipEnergySystems.Other.inputForFlangeCdot inputForFlangeCdot1 annotation(
      Placement(visible = true, transformation(origin = {24, 54}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    ShipEnergySystems.HeatExchanger.HEX_2f HEX(A = 50, L = 10, M_wall = 5, U_pf_ev = 2600, U_pf_sl = 450, U_sf = 50, c_wall = 450, k_wall = 45, rho_wall(displayUnit = "kg/m3") = 5000, L_ev(start = 0.01), mdot_pf_sl2ev(start = 0.2), T_w_sf_in(start = 350), T_w_pf_in(start = 350), T_w_sl2ev(start = 350)) annotation(
      Placement(visible = true, transformation(origin = {-14, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(HEX.OutFlow, ambient.ports[1]) annotation(
